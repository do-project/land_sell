...
do_Page.on("filter_condition_changed", function(data){
	...
	if (data == null || data.viewType != "zhongbiao") return;
...
do_Page.on("zhongbiao_refresh",function(){
	refreshData();
})
